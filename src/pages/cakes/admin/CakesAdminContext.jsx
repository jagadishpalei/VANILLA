...
/* pickupSlot is now an exact time string (e.g. "2:30 PM") — no lookup needed */
export const SLOT_LABEL = new Proxy({}, { get: (_, key) => key || '—' });
...
const SEED_ORDERS = [
  { id:'VC-ORD-2026-00001', cakeId:'VCC-CHO-0001', customer:'Priya Sharma',  phone:'9876543210', email:'priya@example.com',  cake:'Belgian Chocolate Truffle', cakeImg:'/cake-images/chocolate/p-chocolate-truffle-cream-cake-361113-m.avif',   weight:'1Kg',   amount:849,  status:'new_request',  payment:'WhatsApp', pickupSlot:'11:00 AM', pickupDate:today,    pickupCounter:'keonjhar-main', cakeMessage:'Happy Birthday Riya!', note:'Extra candles please', createdAt:hoursAgo(1) },
  { id:'VC-ORD-2026-00002', cakeId:'VCC-RDV-0001', customer:'Rohan Mehta',   phone:'9123456780', email:'rohan@example.com',  cake:'Red Velvet Love Cake',      cakeImg:'/cake-images/red velvet/p-classic-red-velvet-cake-109230-m.avif',       weight:'500g',  amount:899,  status:'approved',     payment:'WhatsApp', pickupSlot:'5:30 PM',  pickupDate:today,    pickupCounter:'barbil',        cakeMessage:'',                     note:'',                     createdAt:hoursAgo(2) },
  { id:'VC-ORD-2026-00003', cakeId:'VCC-DES-0002', customer:'Aisha Khan',    phone:'9988776655', email:'aisha@example.com',  cake:'Floral Garden Fondant',     cakeImg:'/cake-images/desiner/p-floral-garden-fondant-cake-6-kg--112709-m.avif', weight:'2Kg',   amount:2499, status:'new_request',  payment:'WhatsApp', pickupSlot:'10:00 AM', pickupDate:tomorrow, pickupCounter:'keonjhar-main', cakeMessage:'Anniversary special',  note:'White & gold theme',   createdAt:hoursAgo(3) },
  { id:'VC-ORD-2026-00004', cakeId:'VCC-CHO-0002', customer:'Vikram Nair',   phone:'9345678901', email:'vikram@example.com', cake:'Ferrero Rocher Cake',       cakeImg:'/cake-images/chocolate/p-chocolate-hazelnut-crunch-cake-361115-m.avif', weight:'1.5Kg', amount:1149, status:'collected',    payment:'WhatsApp', pickupSlot:'3:00 PM',  pickupDate:daysAgo(1).split('T')[0], pickupCounter:'restaurant', cakeMessage:'',                     note:'',                     createdAt:daysAgo(1) },
  { id:'VC-ORD-2026-00005', cakeId:'VCC-DES-0001', customer:'Meera Joshi',   phone:'9765432109', email:'meera@example.com',  cake:'Sparkling Celebration',     cakeImg:'/cake-images/desiner/p-sparkling-celebration-cream-cake-271465-m.avif', weight:'2Kg',   amount:1499, status:'ready_pickup', payment:'WhatsApp', pickupSlot:'2:30 PM',  pickupDate:today,    pickupCounter:'keonjhar-main', cakeMessage:'Congratulations!',     note:'Gift wrap please',     createdAt:hoursAgo(4) },
  { id:'VC-ORD-2026-00006', cakeId:'VCC-CHO-0004', customer:'Dev Kapoor',    phone:'9654321098', email:'dev@example.com',    cake:'Dark Fantasy Chocolate',    cakeImg:'/cake-images/chocolate/p-decadent-dark-chocolate-cake-269995-m.avif',   weight:'1Kg',   amount:749,  status:'preparing',    payment:'WhatsApp', pickupSlot:'6:45 PM',  pickupDate:today,    pickupCounter:'barbil',        cakeMessage:'Happy Wedding!',       note:'',                     createdAt:hoursAgo(5) },
  { id:'VC-ORD-2026-00007', cakeId:'VCC-CHO-0005', customer:'Sunita Rath',   phone:'7894561230', email:'sunita@example.com', cake:'Chocolate Overload Cake',   cakeImg:'/cake-images/chocolate/p-chocolate-noir-gateau-361085-m.avif',           weight:'1.5Kg', amount:999,  status:'new_request',  payment:'WhatsApp', pickupSlot:'11:30 AM', pickupDate:tomorrow, pickupCounter:'restaurant',    cakeMessage:'Happy Graduation!',    note:'Eggless please',       createdAt:hoursAgo(6) },
];
